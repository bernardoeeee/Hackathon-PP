...
async function enviarMensagem(event) {
    ...
    const response = await fetch('http://localhost:3000/mensagem/Designers', {
        method: "POST",
        body: formData
    });
...
async function listarMensagemDesigners() {
    const response = await fetch('http://localhost:3000/listar/Designers', {
        method: 'GET',
    });
...
setInterval(listarMensagemDesigners, 5000);
